...
func New(stores domain.StoreRepository, participatingStores domain.ParticipatingStoreRepository,
	...
	return &Application{
		appCommands: appCommands{
			...
			EnableParticipationHandler: commands.NewEnableParticipationHanler(stores, domainPublisher),
		...
		appQueries: appQueries{
			...
			GetParticipatingStoresHandler: queries.NewGetParticipatingStoresHandler(stores),
